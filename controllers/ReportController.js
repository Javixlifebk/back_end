			...
			if (!errors.isEmpty()) {
				return apiResponse.validationErrorWithData(res, "Validation Error.", errors.array());
					...
					var options = { method: 'POST',
					  url: 'http://127.0.0.1:3010/api/ngo/screenerById',
					  headers: 
					...
					var options = {
					    ...
					    .then(val => {
					        ...
					        val.filename="http://127.0.0.1:3010/reports/"+temp[temp.length-1];
					...
					var options = { method: 'POST',
					  url: 'http://127.0.0.1:3010/api/ngo/ngoById',
					  headers: 
					   { 'content-type': 'application/x-www-form-urlencoded' },
					  form: 
					   { userId: ngoId,
					...
					var options = { method: 'POST',
					  url: 'http://127.0.0.1:3010/api/doctor/doctorById',
					  headers: 
					   { 'content-type': 'application/x-www-form-urlencoded' },
					  form: 
					   { userId: doctorId,
...
if(req.body.roleId==='4'){
					...
					var options = { method: 'POST',
					  url: 'http://127.0.0.1:3010/api/pharmacy/pharmacyById',
					  headers: 
					   { 'content-type': 'application/x-www-form-urlencoded' },
					  form: 
					   { userId: pharmacyId,
...
if(req.body.roleId==='6'){
					...
					var options = { method: 'POST',
					  url: 'http://127.0.0.1:3010/api/citizen/citizenById',
					  headers: 
					   { 'content-type': 'application/x-www-form-urlencoded' },
					  form: 
					   { userId: citizenId,
		...
		try {
			...
			if (!errors.isEmpty()) {
				...
				console.log("case report",req.body);
					...
					var options = { method: 'POST',
					  url: 'http://127.0.0.1:3010/api/screening/getCaseDetails',
					  headers: 
					   { 'content-type': 'application/x-www-form-urlencoded' },
					  form: 
					   { caseId: caseId,
					  ...
					  url: 'http://127.0.0.1:3010/api/labtest/getHemoglobinList',
					  headers: 
					   { 'content-type': 'application/x-www-form-urlencoded' },
					  form: 
					  ...
					  url: 'http://127.0.0.1:3010/api/labtest/getEyeTestList',
					  headers: 
					   { 'content-type': 'application/x-www-form-urlencoded' },
					  form: 
					   { caseId: caseId,token:token,
					  ...
					  url: 'http://127.0.0.1:3010/api/labtest/getVisualExamList',
					  headers: 
					   { 'content-type': 'application/x-www-form-urlencoded' },
					  form: 
					   { caseId: caseId,token:token,
					  ...
					  url: 'http://127.0.0.1:3010/api/labtest/getBloodGlucoseTestList',
					  headers: 
					   { 'content-type': 'application/x-www-form-urlencoded' },
					  form: 
					   { caseId: caseId,token:token,
					  ...
					  url: 'http://127.0.0.1:3010/api/labtest/getLipidPanelTestList',
					  headers: 
					   { 'content-type': 'application/x-www-form-urlencoded' },
					  form: 
					   { caseId: caseId,token:token,
					  ...
					  url: 'http://127.0.0.1:3010/api/labtest/getDrugTestList',
					  headers: 
					   { 'content-type': 'application/x-www-form-urlencoded' },
					  form: 
					   { caseId: caseId,token:token,
					  ...
					  url: 'http://127.0.0.1:3010/api/labtest/getLabTestList',
					  headers: 
					   { 'content-type': 'application/x-www-form-urlencoded' },
					  form: 
					   { caseId: caseId,token:token,
					  ...
					  url: 'http://127.0.0.1:3010/api/labtest/getSickleCell',
					  headers: 
					   { 'content-type': 'application/x-www-form-urlencoded' },
					  form: 
					   { caseId: caseId,
					  ...
					  url: 'http://127.0.0.1:3010/api/labtest/getThalassemia',
					  headers: 
					   { 'content-type': 'application/x-www-form-urlencoded' },
					  form: 
					   { caseId: caseId,
					  ...
					  url: 'http://127.0.0.1:3010/api/labtest/getLungTest',
					  headers: 
					   { 'content-type': 'application/x-www-form-urlencoded' },
					  form: 
					   { caseId: caseId,
					  ...
					  url: 'http://127.0.0.1:3010/api/labtest/getHeartTestList',
					  headers: 
					   { 'content-type': 'application/x-www-form-urlencoded' },
					  form: 
					  ...
					  url: 'http://127.0.0.1:3010/api/labtest/getUrineTestList',
					  headers: 
					   { 'content-type': 'application/x-www-form-urlencoded' },
					  form: 
					   { caseId: caseId,token:'adsdasdadasda',
					  ...
					  url: 'http://127.0.0.1:3010/api/screening/SymptomsList',
					  headers: 
					   { 'content-type': 'application/x-www-form-urlencoded' },
					  form: 
					   { caseId: caseId,token:'adsdasdadasda',
					   ...
					   url: 'http://127.0.0.1:3010/api/test/getByCaseId',
					   headers: 
						{ 'content-type': 'application/x-www-form-urlencoded' },
					   form: 
						{ caseId: caseId,
							...
							//   console.dir(global_labs.heart);
							 ...
							 // }
							  ...
							  await merger.save(file);
					        	...
					        	val.filename="http://127.0.0.1:3010/reports/"+temp1[temp1.length-1];
					        	return apiResponse.successResponseWithData(res,"Success",val);
							})();
		...
		try {
			...
			if (!errors.isEmpty()) {
				return apiResponse.validationErrorWithData(res, "Validation Error.", errors.array());
					...
					var options = { method: 'POST',
					  url: 'http://127.0.0.1:3010/api/citizen/getHistoryAllergy',
					  headers: 
					   { 'content-type': 'application/x-www-form-urlencoded' },
					  form: 
					   { citizenId: citizenId,
					   ...
					   var options1 = { method: 'POST',
					  url: 'http://127.0.0.1:3010/api/citizen/getHistoryMedical',
					  headers: 
					   { 'content-type': 'application/x-www-form-urlencoded' },
					  form: 
					   { citizenId: citizenId,
					   ...
					   var options2 = { method: 'POST',
					  url: 'http://127.0.0.1:3010/api/citizen/getHistoryWomen',
					  headers: 
					   { 'content-type': 'application/x-www-form-urlencoded' },
					  form: 
					   { citizenId: citizenId,
					   ...
					   var options3 = { method: 'POST',
					  url: 'http://127.0.0.1:3010/api/citizen/getHistoryFamily',
					  headers: 
					   { 'content-type': 'application/x-www-form-urlencoded' },
					  form: 
					   { citizenId: citizenId,
					   ...
					   var options4 = { method: 'POST',
					  url: 'http://127.0.0.1:3010/api/citizen/getHistoryPersonal',
					  headers: 
					   { 'content-type': 'application/x-www-form-urlencoded' },
					  form: 
					   { citizenId: citizenId,
		...
		try {
			...
			if (!errors.isEmpty()) {
				return apiResponse.validationErrorWithData(res, "Validation Error.", errors.array());
					...
					var options = { method: 'POST',
					  url: 'http://127.0.0.1:3010/api/doctor/prescriptionlist',
					  headers: 
					   { 'content-type': 'application/x-www-form-urlencoded' },
					  form: 
					   { caseId: caseId,

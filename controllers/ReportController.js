				...
				return apiResponse.validationErrorWithData(res, "Validation Error.", errors.array());
					...
					var options = { method: 'POST',
					  ...
					  if(status==1){
						...
						labs.ezerx[0]['name_key']= {"name_key":'Hemoglobin',"value_key": ezerx_data[0].non_invasive_hemoglobin_value,'range':ezerx_data[0].non_invasive_hemoglobin_range,'unit': 'g/dl'};

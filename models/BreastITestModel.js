...
const breastItestschema = new mongoose.Schema(
  {
    ...
    lumps_checked: { type: Boolean, required: false, default: false },
    ...
    niple_discharge_checked: { type: Boolean, required: false, default: false },
    ...
    niple_skin_checked: { type: Boolean, required: false, default: false },
    ...
    swelling_checked: { type: Boolean, required: false, default: false },
    ...
    rush_scaling_checked: { type: Boolean, required: false, default: false },
    ...
    note_breast_right: { type: String, required: false },
    note_breast_left: { type: String, required: false },
